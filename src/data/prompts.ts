// Canned quick-reply prompts shown as suggestion chips in the chat composer.
// These are just UI shortcuts for a question the user can already type
// themselves — every reply still comes from the real backend AI service.
