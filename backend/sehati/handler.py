...
_ROUTES = [
    ...
    _Route("POST", "/cases/{caseId}/consultation", "setConsultation"),
    _Route("POST", "/cases/{caseId}/exams", "recommendExams"),
    _Route("POST", "/cases/{caseId}/exams/custom", "addCustomExam"),
    ...
    _Route("POST", "/cases/{caseId}/diagnoses/analyze", "analyzeResults"),
    ...
    _Route("POST", "/cases/{caseId}/resolve", "resolveCase"),
    _Route("POST", "/cases/{caseId}/reopen", "reopenCase"),
    _Route("POST", "/cases/{caseId}/tests/recommend", "recommendTests"),
    _Route("POST", "/cases/{caseId}/tests/custom", "addCustomTest"),
    _Route("POST", "/cases/{caseId}/tests/{testId}/order", "orderTest"),
    _Route("PUT", "/cases/{caseId}/tests/{testId}", "updateTest"),
